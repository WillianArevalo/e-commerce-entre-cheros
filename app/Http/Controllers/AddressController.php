...
class AddressController extends Controller
{
     ...
     */
    public function storeAccount(AddressRequest $request)
    {
        $validated = $request->validated();
        $user =  auth()->user();
        $customer = Customer::where("user_id", $user->id)->first();
     ...
     */
    public function editAccount(string $slug)
    {
     ...
     */
    public function updateAccount(AddressRequest $request, string $id)
    {
        $validated = $request->validated();
        $address = Address::find($id);
