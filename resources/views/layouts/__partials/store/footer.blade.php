    ...
    <div class="footer relative bg-secondary px-20 pb-10">
        ...
        <div class="mt-4 flex w-full justify-between">
            <div class="flex gap-20">
                <div>
                    <ul class="flex w-52 flex-col gap-2 font-league-spartan text-primary">
            ...
            <div class="flex flex-col gap-2">
                <h2 class="font-league-spartan text-xl font-bold uppercase text-white">Sigamos en contacto</h2>
                <div>
