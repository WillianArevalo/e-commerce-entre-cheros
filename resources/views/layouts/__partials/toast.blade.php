@if ($message = Session::get('success'))
    <div id="toast-danger"
        class="fixed flex items-center gap-4 justify-between w-full max-w-xs p-4  text-gray-500 bg-white rounded-lg shadow top-5 right-5 dark:text-gray-400 dark:bg-gray-800 font-secondary"
        role="alert">
        <div
