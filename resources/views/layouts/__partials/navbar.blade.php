<header class=" w-full {{ $classHead ?? '' }}">
    <nav
        ...
        <ul class="flex gap-6 items-center">
            <li>
                <a href="" class="text-secondary hover:text-rose-500">
            ...
            <li class="relative group">
                @if ($user = auth()->user())
                    ...
                    <div
                        class="absolute bg-white rounded-lg w-40 font-secondary text-sm overflow-hidden hidden group-hover:block shadow-md">
                        <ul class="flex flex-col">
                            <li class="px-4 py-2 hover:bg-zinc-100 w-full">
                                <a href="" class="block w-full">Perfil</a>
                            </li>
                            <li class="px-4 py-2 hover:bg-zinc-100 w-full">
                                <a href="" class="block w-full">Favoritos</a>
                            </li>
                            <li class="px-4 py-2 hover:bg-zinc-100 w-full">
