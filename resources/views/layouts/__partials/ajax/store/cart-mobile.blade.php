 @if ($cart && $cart->items->count())
     @foreach ($cart->items as $item)
         <div class="mb-4 rounded-xl border border-zinc-200 bg-white shadow-md">
             <!-- Producto e Imagen -->
             <div class="flex items-center px-4 pt-4 max-[360px]:flex-col max-[360px]:items-start">
             ...
             <!-- Cantidad -->
             <div class="mt-4 px-4">
                 <label class="block text-sm font-medium text-zinc-500">Cantidad</label>
             ...
             <div class="mt-4 flex items-center justify-between border-t border-zinc-300 p-4">
