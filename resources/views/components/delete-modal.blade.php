  <div id="{{ $modalId }}" tabindex="-1" aria-hidden="true"
      ...
      <div class="relative h-full w-full max-w-md animate-fade p-4 animate-duration-300 animate-once md:h-auto">
          ...
          <div class="relative rounded-lg bg-white p-4 text-center shadow dark:bg-zinc-950 sm:p-5">
              <button type="button"
                  class="closeModal absolute right-2.5 top-2.5 ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-zinc-900 dark:hover:text-white"
              ...
              <svg class="mx-auto mb-3.5 h-11 w-11 text-gray-400 dark:text-gray-500" aria-hidden="true"
