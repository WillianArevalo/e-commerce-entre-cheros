...
@section('content')
    <div>
        <div class="flex items-center gap-2 p-4">
            <x-icon icon="dashboard-square" class="ml-2 h-8 w-8 text-primary-600" />
            ...
            <div class="flex-1">
                    ...
                    <div class="h-full flex-1 rounded-xl border border-zinc-400 p-4 dark:border-zinc-800">
                        <div class="flex items-center gap-1">
                            <span
                                ...
                                <x-icon icon="user-plus" class="dark:text-primary-dark h-8 w-8 text-primary-600" />
                            </span>
                            <span class="dark:text-primary-dark text-5xl font-bold text-primary-600">20</span>
                        </div>
                        <span class="font-league-spartan text-xl font-semibold text-zinc-600 dark:text-zinc-300">
                            Nuevos clientes
                        </span>
                    </div>
                ...
                <div class="mt-4 h-max flex-1 rounded-xl border border-zinc-400 dark:border-zinc-800">
                    <div class="flex flex-col rounded-t-xl border-b border-zinc-400 pb-4 dark:border-zinc-800">
                        ...
                        <span class="font-secondary px-4 text-5xl font-bold text-primary-600">
                            $400,000
                        </span>
                    </div>
                    <div class="h-max p-6">
                ...
                <div class="flex gap-4">
                    <div class="h-max flex-1 overflow-hidden rounded-xl border border-zinc-400 dark:border-zinc-800">
                        <div class="bg-zinc-100 p-4 dark:bg-zinc-950">
                            ...
                            <p class="text-3xl font-bold text-primary-600">4.890</p>
                    ...
                    <div class="h-max flex-1 overflow-hidden rounded-xl border border-zinc-400 dark:border-zinc-800">
                        <div class="bg-zinc-100 p-4 dark:bg-zinc-950">
                            ...
                            <p class="dark:text-primary-dark text-3xl font-bold text-primary-600">400</p>
                            <p class="text-xs uppercase text-zinc-500 dark:text-zinc-600">
                                Todos los pedidos
                            </p>
                        </div>
        ...
        <div class="mt-4 border-t border-zinc-400 dark:border-zinc-800">
            <div class="m-4 overflow-hidden rounded-lg border border-zinc-400 dark:border-zinc-800">
                <div
                    ...
                    <h2 class="p-4 text-2xl font-bold uppercase text-primary-600">
                        Últimos pedidos
                    </h2>
