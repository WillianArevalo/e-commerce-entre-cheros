            ...
            <div class="mx-auto w-full">
                <form action="{{ route('admin.users.store') }}" class="flex flex-col gap-4" enctype="multipart/form-data"
                    ...
                    <div class="flex gap-4">
                        <div
                            class="bg-whtie flex h-max flex-1 flex-col rounded-lg border border-gray-300 dark:border-zinc-900 dark:bg-black">
                            <p
                            ...
                            <div class="flex justify-end border-t border-gray-200 dark:border-zinc-900">
                                <label for="profile"
