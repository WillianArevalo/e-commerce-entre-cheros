                        ...
                        <div class="flex flex-col gap-4">
                            <div class="flex gap-4">
                                <div class="flex-[2]">
                                    <x-input type="text" name="code" id="code" label="Código"
                                        value="{{ old('code') }}" placeholder="Ingresa el código único del cupón"
                                        required />
                                </div>
                                <div class="flex-1">
                            ...
                            <div class="flex gap-4">
                                ...
                                <div class="flex-1">
                                    <x-input type="number" step="0.1" min="0.1" name="discount_value"
                                        id="discount_value" label="Valor del descuento" value="{{ old('discount_value') }}"
                            ...
                            <div class="flex">
                                <div class="rules special_date mb-4 hidden w-72">
                                    <x-input type="date" name="parameters[]" id="parameters_date" label="Fecha especial"
                                        icon="calendar" />
                                </div>
