        ...
        <section class="p-4 dark:bg-black">
            ...
            <div class="mt-3 rounded-lg border border-zinc-400 dark:border-zinc-800">
                <div class="border-b border-zinc-400 p-4 dark:border-zinc-800">
                    <span
                        class="inline-block rounded-full bg-primary-100 px-2 py-1 text-xs font-semibold uppercase text-primary-500 dark:bg-primary-900 dark:text-primary-300">
                        Administrador
                    </span>
                </div>
                ...
                <div class="border-t border-zinc-400 p-4 dark:border-zinc-800">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-2 flex gap-2">
                            ...
                            <x-button type="secondary" typeButton="secondary" text="Cambiar correo" icon="mail-forward" />
                        </div>
                    </div>
                    <div class="mt-4">
                        ...
                        <form action="">
                            ...
                            <div class="mt-4">
                                <div class="flex gap-4">
                                    ...
                                    <div class="flex flex-1 flex-col">
                                        <x-input type="date" label="Fecha de cumpleaños" icon="calendar" name="birthdate"
                        ...
                        <div class="mt-4 flex items-center gap-4">
                            <div class="w-60">
                                <x-select label="Lenguaje" name="language" id="language"
                                    value="{{ $user->locale ?? '' }}" label="Idioma" class="w-80" :options="[
                                        'en' => 'Inglés',
                                        'es' => 'Epañol',
                                    ]"
