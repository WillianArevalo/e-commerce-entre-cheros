    ...
    <main>
        <section class="mt-32">
            <div class="container mx-auto px-4">
                <h1 class="mt-10 block text-center font-tertiary text-5xl font-normal uppercase text-secondary"
                    data-aos="fade-down">
                    Preguntas frecuentes
                </h1>
                <div class="mx-auto mt-10 flex w-1/2 flex-col">
                    @foreach ($faqs as $faq)
                        <div class="mt-4 flex flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white"
                            ...
                            <button class="show-question flex items-center justify-between px-6 py-2 hover:bg-zinc-100">
                                <span class="flex items-center justify-center gap-2">
                                    ...
                                    <h2 class="mt-1 font-primary text-2xl font-semibold text-secondary">{{ $faq->question }}
                                    </h2>
                                </span>
                                <x-icon-store icon="arrow-down" class="h-8 w-8 text-secondary" />
                            </button>
                            <div class="hidden animate-fade-down border-t border-zinc-200 py-4">
                                <p class="text-wrap ms-16 w-4/5 font-secondary text-sm text-secondary">{{ $faq->answer }}
                                </p>
                            </div>
                        </div>
                    @endforeach
